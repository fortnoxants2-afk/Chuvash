...
const Dice: React.FC<DiceProps> = ({ onBack, onNavigateToSettings }) => {
  ...
  const getOkButtonImage = () => {
    // Теперь кнопка выглядит нажатой только когда на неё физически давят
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      <div className="flex-1 relative z-50">
        <div 
          className="absolute left-1/2 -translate-x-1/2 w-[82.4%] max-w-[340px] aspect-[556/958]"
          style={{ bottom: '7.5%' }}
        >
          ...
          <button 
            ...
            className="absolute top-[-2.8%] right-[-1.1%] w-[12.36%] aspect-square z-50 active:scale-90 transition-transform"
          >
